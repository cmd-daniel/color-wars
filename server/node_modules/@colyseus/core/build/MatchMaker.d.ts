...
import { IRoomCache, MatchMakerDriver, SortOptions } from '@colyseus/core/build/matchmaker/driver/local/LocalDriver';
import controller from '@colyseus/core/build/matchmaker/controller';
import * as stats from '@colyseus/core/build/Stats';
import { AuthContext } from '@colyseus/core/build/Transport';
...
export declare function reconnect(roomId: string, clientOptions?: ClientOptions): Promise<{
    room: import("@colyseus/core/build/matchmaker/driver/api").RoomCache<any>;
    sessionId: any;
}>;
/**
 ...
 */
export declare function findOneRoomAvailable(roomName: string, filterOptions: ClientOptions, additionalSortOptions?: SortOptions): Promise<import("@colyseus/core/build/matchmaker/driver/api").RoomCache<any>>;
/**
 ...
 */
export declare function getRoomById(roomId: string): Promise<import("@colyseus/core/build/matchmaker/driver/api").RoomCache<any>>;
/**
