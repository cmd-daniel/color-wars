import { DefinitionType } from "@colyseus/schema/lib/annotations";
import { $descriptors, $fieldIndexesByViewTag, $numFields, $refTypeFieldIndexes, $viewFieldIndexes } from "@colyseus/schema/lib/types/symbols";
