import { Collection, NonFunctionNonPrimitivePropNames, NonFunctionPropNames } from "@colyseus/schema/lib/types/HelperTypes";
import { Decoder } from "@colyseus/schema/lib/decoder/Decoder";
